...
def main():
    ...
    quant_path = "Frostrabbit/Llama-3.2-3B-Instruct-GPTQ-4bit-32-256"
    ...
    for i in tqdm(range(5), desc="Warm Up..."):
        ...
        _ = engine.generate(warmup_prompt, {"temperature": 0.6, "max_new_tokens": max_new_tokens})
    ...
    for _ in tqdm(range(10), desc="Test Inference"):
        ...
        tput = total_completion_tokens / (elapsed_ms / 1000)
    ...
    if engine is not None:
        ...
        engine.shutdown()
        print("SGLang Engine Shutdown complete.")
